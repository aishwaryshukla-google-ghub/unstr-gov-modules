...
def list_catalog_namespaces_and_tables(
    ...
    # 2. Query Namespaces List API (Exact Verified URL)
    ...
    # 3. Query Tables in each Namespace (Exact Verified URL)
    total_tables = 0
    tables_by_namespace = {}
    ...
    # 4. Describe Target Table Schema & Columns (Exact Verified URL)
